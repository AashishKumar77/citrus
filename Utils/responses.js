...
module.exports = {
    ...
    INVALID_PROPERTY_ID: {
        statusCode: 400,
        customMessage: 'Invalid property id',
    ...
    disputeAlreadyRaised: {
        statusCode: 400,
        status: "error",
        message: 'Dispute already raised for this Trademen.'
    },
    profileUpdate: {
        statusCode: 200,
        status: "success",
    ...
    fileLengthExceeded: {
        ...
        type: 'fileLengthExceeded',
    },
    PLEASE_ENTER_BANK_DETAILS: {
        statusCode: 400,
        status: "warning",
        customMessage: "please enter bank details.",
        type: 'PLEASE_ENTER_BANK_DETAILS',
    },
    fileNotFound: {
        statusCode: 404,
        status: "warning",
    ...
    LINK_ALREADY_EXIST: {
        statusCode: 400,
        customMessage: 'URL already exists',
    ...
    TESTIMONIAL_ALREADY_EXIST: {
        statusCode: 400,
        customMessage: 'Testimonial already exists',
        type: 'TESTIMONIAL_ALREADY_EXIST',
        /*error:{
         errorCode:400,
         errorDescription: 'Email already exists.'
         }*/
    ...
    TOKEN_NOT_VALID: {
        statusCode: 401,
        status: "error",
        customMessage: 'Session Expired.', message:'Session Expired.',
    ...
    INVALID_EXPECTED_EXPIRE_DATE: {
        statusCode: 400,
        status: "warning",
        message: 'Invalid expected Expiry Date.',
        type: 'INVALID_EXPECTED_START_DATE'
    },
    USER_IS_NOT_VERIFY: {
        statusCode: 400,
    ...
    PLEASE_ADD_CARD: {
        statusCode: 400,
        status: "error",
        customMessage: 'Please add your card details to hire Trademen',
    ...
    YOU_ALREADY_HIRED_TRADIE:{
        statusCode: 400,
        status: "error",
        customMessage: 'You have already hired a Trademen for this Category',
    ...
    YOU_ALREADY_DISAPPROVED_TRADIE:{
        statusCode: 400,
        status: "error",
        customMessage: 'you already rejected tradie',
        type: 'YOU_ALREADY_DISAPPROVED_TRADIE',
    },
    YOU_ALREADY_RATE_CONSUMER:{
        statusCode: 400,
        status: "error",
        customMessage: 'You have already rated for this job',
        type: 'YOU_ALREADY_RATE_CONSUMER',
    },
    YOU_ALREADY_RATE_TRADIE:{
        statusCode: 400,
        status: "error",
        customMessage: 'You have already rated for this job',
        type: 'YOU_ALREADY_RATE_TRADIE',
    },
    JOB_IS_NOT_COMPLETED_STATE: {
        statusCode: 400,
        status: "warning",
        customMessage: "You can't perform this action right now.",
        type: 'JOB_IS_NOT_COMPLETED_STATE',
    },
    BANK_ACCOUNT_IS_NOT_ADDED: {
        statusCode: 400,
        status: "warning",
        customMessage: "bank account is not added",
        type: 'BANK_ACCOUNT_IS_NOT_ADDED',
    },
    ANOTHER_TRADIE_IS_HIRED:{
        statusCode: 400,
        status: "error",
        customMessage: 'Another Tradie is hired on this job',
        type: 'ANOTHER_TRADIE_IS_HIRED',
    },
    CategoryidNotExist: {
        statusCode: 400,
        status: "warning",
        ...
        type: 'CategoryidNotExist',
    },
    INVITE_YOURSELF: {
        statusCode: 400,
        status: "warning",
        message: 'You are not allowed to invite yourself.',
        customMessage: 'You are not allowed to invite yourself.',
        type: 'INVITE_YOURSELF',
    },
    ALREADY_INVITED_TRADIE: {
        statusCode: 400,
        status: "warning",
        message: 'Already invited tradie on this job.',
        type: 'ALREADY_INVITED_TRADIE'
    },
    YOUR_ACCOUNT_IS_SUSPENDED: {
        statusCode: 400,
        customMessage: 'Your profile has been deactivated. Please contact Admin "admin@TradePeople.com"',
        customMessage: 'Your profile has been deactivated. Please contact Admin "admin@jaydee.com"',
        type: 'YOUR_ACCOUNT_IS_SUSPENDED',
    },
    INVALID_SORT_CODE: {
        statusCode: 400,
        status: "error",
        message: 'Invalid Sort Code',
        type: 'INVALID_SORT_CODE',
    },
    DISPUTED_SOLVED: {
        statusCode: 200,
        message: 'Dispute Resolved',
        type: 'DISPUTED_SOLVED',
    },
    TRADIE_ACCOUNT_NOT_EXITS:{
        statusCode: 400,
        status: "warning",
        type:"TRADIE_ACCOUNT_NOT_EXITS",
        customMessage: "Tradie bank account not exists."
    },
    TRADIE_ACCOUNT_IS_NOT_VERIFIED:{
        statusCode: 400,
        status: "warning",
        type:"TRADIE_ACCOUNT_IS_NOT_VERIFIED",
        message: "Tradie account is not verifiy"
    },
    PAYMENT_ALREADY_RELEASE:{
        statusCode: 400,
        status: "warning",
        type:"PAYMENT_ALREADY_RELEASE",
        responseType: "PAYMENT_ALREADY_RELEASE",
        message: "Payment alreday Released"
    },
    DISPUTED_IS_NOT_SOLVED: {
        statusCode: 400,
        status: "error",
        message: 'Dispute is not solved.',
        type:"DISPUTED_IS_NOT_RESOLVED",
        responseType: "DISPUTED_IS_NOT_RESOLVED",
    },
    CATEGORY_NOT_VERIFY: {
        statusCode: 400,
        customMessage: 'Categories are not verified yet',
        type: 'CATEGORY_NOT_VERIFY',
    },
    ACCOUNT_ALREADY_VERIFY: {
        statusCode: 400,
        status: "warning",
        message: 'Account is already verified.',
        customMessage: 'Account is already verified.',
        type: 'ACCOUNT_ALREADY_VERIFY',
    },
    EMAIL_ID_NOT_EXISTS: {
        statusCode: 400,
        status: "warning",
    ...
    TOKEN_EXISTS_EMAIL_IS_VERIFY: {
        statusCode: 400,
        status: "warning",
        message: 'TOKEN_EXISTS_EMAIL_IS_VERIFY',
        customMessage: 'TOKEN_EXISTS_EMAIL_IS_VERIFY',
        type: 'TOKEN_EXISTS_EMAIL_IS_VERIFY',
    },
    TOKEN_NOT_EXISTS_EMAIL_IS_VERIFY: {
        statusCode: 400,
        status: "warning",
        message: 'TOKEN_NOT_EXISTS_EMAIL_IS_VERIFY',
        customMessage: 'TOKEN_EXISTS_EMAIL_IS_VERIFY',
        type: 'TOKEN_NOT_EXISTS_EMAIL_IS_VERIFY',
    },
    TOKEN_NOT_EXISTS_AND_EMAIL_IS_NOT_VERIFY: {
        statusCode: 400,
        status: "warning",
        message: 'TOKEN_NOT_EXISTS_AND_EMAIL_IS_NOT_VERIFY',
        customMessage: 'TOKEN_NOT_EXISTS_AND_EMAIL_IS_NOT_VERIFY',
        type: 'TOKEN_NOT_EXISTS_AND_EMAIL_IS_NOT_VERIFY',
    },
    YOUR_LISTING_HAS_BEEN_SAVED:{
        statusCode: 200,
        customMessage: 'Your listing has been saved',
        message: 'Your listing has been saved',
        type: 'YOUR_LISTING_HAS_BEEN_SAVED'
    },
    REMOVE_LISTING:{
        statusCode: 200,
        customMessage: 'Your listing has been removed from saved listings',
        message: 'Your listing has been removed from saved listings',
        type: 'REMOVE_LISTING'
    },
    SCHOOL_ALREADY_EXIST: {
        statusCode: 400,
         message: 'School already exists',
        customMessage: 'School already exists',
        type: 'SCHOOL_ALREADY_EXIST',

    },
    INVALID_SCHOOL_ID: {
        statusCode: 400,
        customMessage: 'Invalid school id',
    ...
    FORGOT_PASSWORD_TOKEN_EXPIRED: {
        ...
        customMessage: 'Link is expired. Please generate new Link',
        type: "FORGOT_PASSWORD_TOKEN_EXPIRED"
    },
    YOUR_LISTING_HAS_BEEN_MARKED_AS_FAVORITE:{
        statusCode: 200,
        customMessage: 'Your listing has been marked as favorite',
        message: 'Your listing has been marked as favorite',
        type: 'YOUR_LISTING_HAS_BEEN_MARKED_AS_FAVORITE'
    },
    YOUR_LISTING_HAS_BEEN_MARKED_AS_UNFAVORITE:{
        statusCode: 200,
        customMessage: 'Your listing has been removed from favorite',
        message: 'Your listing has been removed from favorite',
        type: 'YOUR_LISTING_HAS_BEEN_MARKED_AS_UNFAVORITE'
    },
    MLS_NUMBER_IS_NOT_VALID:{
        statusCode: 400,
        customMessage: 'MLS Number is not valid',
        message: 'MLS Number is not valid' ,
        type: 'MLS_NUMBER_IS_NOT_VALID'
    },
    YOUR_SEARCH_HAS_BEEN_SAVED:{
        statusCode: 200,
        customMessage: 'Your Search has been saved',
        message: 'Your listing has been saved',
        type: 'YOUR_LISTING_HAS_BEEN_SAVED'
    },
    INVALID_PROPERTY_ID: {
    ...
    YOUR_ACCOUNT_IS_BLOCK: {
        statusCode: 400,
        customMessage: "Your account is blocked. Please contact admin",
        type: 'YOUR_ACCOUNT_IS_BLOCK',
    },
    EMAIL_NOT_VERIFIED: {
        statusCode: 400,
        customMessage: "Please verify your email address",
    ...
    SLUG_ALREADY_EXISTS: {
        ...
        responseType: "SLUG_ALREADY_EXISTS",
    ...
    PROPERTY_ALREADY_EXISTS: {
        ...
        customMessage: 'Property already exists',
        responseType: "PROPERTY_ALREADY_EXISTS",
        type: 'PROPERTY_ALREADY_EXISTS',
    },
    LISTING_ID_ALREADY_EXISTS: {
        statusCode: 400,
        status: "warning",
        message: 'Listing id already exists',
        customMessage: 'Listing id already exists',
        responseType: "LISTING_ID_ALREADY_EXISTS",
        type: 'LISTING_ID_ALREADY_EXISTS',
    },
    NO_PLAN_EXISTS: {
        statusCode: 400,
        status: "warning",
        message: '"No such plan',
        customMessage: 'No such plan',
        responseType: "NO_PLAN_EXISTS",
        type: 'NO_PLAN_EXISTS',
    },
    selectfunnel: {
        statusCode: 400,
        status: "error",
        message: 'Please select Funnel for HomeWorth under Theme Settings.'
    }
};

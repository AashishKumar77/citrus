...
var CmsUserDataSchema = new Schema({
...
CmsUserDataSchema.plugin(mongooseSequence, { inc_field: 'autoIncrement' });
var CmsUserData = Mongoose.model('cmsuserdata', CmsUserDataSchema);
module.exports = CmsUserData;
